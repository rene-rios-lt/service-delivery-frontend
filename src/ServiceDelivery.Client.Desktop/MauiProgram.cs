...
public static class MauiProgram
{
	...
	public static MauiApp CreateMauiApp()
	{
		...
		// Requester pending / "finding your technician" view (FE-016). Desktop hosts the Requester
		// persona. The RequesterHub client is push-driven (no polling); RequesterPendingViewModel sources
		// the requester's real tier from IAuthService and navigates to the tracking view on RepAssigned.
